    ...
    <main className="flex-1 flex flex-col pt-24 px-6 w-full max-w-3xl mx-auto pb-32">
      ...
      <header className="mb-16 border-b border-slate-200 pb-12">
        ...
        <p className="text-2xl text-slate-600 font-normal leading-relaxed">
          The technology works, but the organisation doesn&apos;t. Examining the structural inertia, compliance friction, and cultural gaps that trap AI initiatives in perpetual proof-of-concept purgatory.
        </p>
      </header>
      ...
      <article className="py-12 md:py-16">
        ...
        <ul className="list-disc pl-6 mb-6 text-slate-700 text-lg leading-relaxed">
          <li className="mb-2"><strong className="font-semibold text-slate-900">Strategic Use-Case Prioritisation:</strong> Stop solving novelty problems. Target high-friction, high-cost operational workflows where ROI can be definitively measured.</li>
          <li className="mb-2"><strong className="font-semibold text-slate-900">Hub-and-Spoke Enablement:</strong> A centralised AI Centre of Excellence (CoE) that provides secure infrastructure, while decentralised business units iterate on specific applications.</li>
        ...
        <h2 className="text-slate-900 text-2xl font-bold mt-10 mb-4 tracking-tight">Conclusion: Engineering the Organisation</h2>
        <p className="text-slate-700 text-lg leading-relaxed mb-6 font-normal">
      ...
      <div className="mt-12 pt-12 border-t border-slate-200">
        <div className="bg-slate-50 p-10 border border-slate-200 text-center rounded-sm">
          ...
          <p className="text-slate-600 font-normal mb-8 max-w-xl mx-auto">
            Stop stalling at the PoC stage. Schedule an executive briefing to discuss how Distild can engineer your organisation for scalable AI adoption.
          </p>
